 ...
 * Source Class: DefaultColour <br>
 * @version generated on Wed Nov 16 17:10:01 IST 2016 by Sai
 */
public class DefaultColour extends WrappedIndividualImpl implements Colour {

    public DefaultColour(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
    }
    ...
    public Collection<? extends String> getColourName() {
		return getDelegate().getPropertyValues(getOwlIndividual(), Vocabulary.DATA_PROPERTY_COLOURNAME, String.class);
    }

    public boolean hasColourName() {
		return !getColourName().isEmpty();
    }

    public void addColourName(String newColourName) {
	    getDelegate().addPropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_COLOURNAME, newColourName);
    }

    public void removeColourName(String oldColourName) {
		getDelegate().removePropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_COLOURNAME, oldColourName);
    }
